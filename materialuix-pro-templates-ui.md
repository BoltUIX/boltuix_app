...
**Bolt UIX** built the **MaterialUIX - Kotlin Material Design UI 1.1** as a paid app. This SERVICE is provided by Bolt UIX at no cost and is intended for use as is.
...
You can download the source code here and use these templates for your personal projects. However, if we find any activities such as sharing the templates with others or uploading them to a public repository (like GitHub), your access to future updates will be discontinued.
